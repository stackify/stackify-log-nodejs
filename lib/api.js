...
module.exports.methods = {
    ...
    */
    ...
    sendToSocket: function sendToSocket(messages, success, shutdown) {
        ...
        for(i=0; i<length; i++) {
            ...
            if (messages[i]['Ex']) {
                ...
                if (ex['Error']) {
                    ...
                    if (error['StackTrace']) {
                        ...
                        error_item.setStacktraceList(trace_frame);
                    }
            ...
            log_group.setLogsList(new Array(log));
        }

        // Serializes to a UInt8Array.
        var data = log_group.serializeBinary();
        unix_socket.send(opt, data, success, shutdown);
    }
}
