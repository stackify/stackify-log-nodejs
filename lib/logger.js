var api     = require('./api'),
    ...
    /**
     * Add MesageObject to storage/queue
     * @param messageObject
     */
    addMessageObjectToStorage = function addMessageObjectToStorage (messageObject) {
      if (storage && messageObject) {
...
module.exports = {
    ...
    addMessageObjectToStorage: addMessageObjectToStorage,
    ...
    methods: {
        ...
        push: function push(level, msg, meta, req, err) {
            ...
            addMessageObjectToStorage(messageObject)
        },
