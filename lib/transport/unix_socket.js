...
exports.send = function send (data, cb) {
  console.log('unix socket.js')

  try {
    debug.write("Unix socket.send()");
    ...
    debug.writeSync("error in unix socket: " + error);
    cb({message: error}, null)
  }
}
